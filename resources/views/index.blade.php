...
@section('content')
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src={{asset("assets/img/img.bg.jpg")}} alt="" data-aos="fade-in" class="">

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <h2>Nurunnahar Bithi</h2>
        <p>I'm <span class="typed" data-typed-items="Designer, Developer, Freelancer">Website Designer</span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About Me</h2>
        <p>Hello! I'm Nurunnahar Bithi, a passionate and dedicated freelance web developer with a strong background in PHP, Laravel, HTML, CSS, Bootstrap, and Java. I specialize in creating responsive, user-friendly, and visually appealing websites that meet clients' needs and exceed their expectations.

With a Master’s degree in Commerce and experience in freelancing, I’ve combined my technical skills with creativity and problem-solving abilities to deliver high-quality web solutions. Whether it’s building a personal portfolio, an e-commerce site, or a business website, I’m here to turn ideas into reality.

I believe in continuous learning and always strive to stay up-to-date with the latest web technologies. Let's work together and bring your digital vision to life!
</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src={{asset("assets/img/profile-1.jpg")}} class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 content">
            <h2>UI/UX Designer &amp; Web Developer.</h2>
            <p class="fst-italic py-3">
              I am a passionate UI/UX Designer and Web Developer, dedicated to crafting modern, responsive, and user-friendly designs. My goal is to create smooth and effective digital experiences that are both visually appealing and functional.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>20 May 1987</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>01911233147</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Dhaka,bngladesh</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>38</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>M.B.S</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>tehzeebbithi.2016@gmail.com</span></li>
            ...
            <p class="py-3">
             Additional Info:
I work with full dedication on carefully selected projects. I am committed to delivering high-quality, on-time, and professional services. My work is driven by honesty, skill, and a strong focus on client satisfaction.
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="skills section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Skills</h2>
        <p>“I design and develop clean, user-friendly websites that deliver real value.”</p>
      </div><!-- End Section Title -->
